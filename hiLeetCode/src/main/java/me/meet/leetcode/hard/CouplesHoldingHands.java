...
public class CouplesHoldingHands {
    ...
    static int unionFind(int[] arr, int i) {
        return (i == arr[i] ? i : unionFind(arr, arr[i]));
    }

//    static int mapUnionFindMinSwapCouples(int[] arr) {
//        if (null == arr) {
//            throw new IllegalArgumentException();
//
//        }
//        int res = 0, n = arr.length, cnt = n/2;
//        if (0 != n%2) {
//            throw new IllegalArgumentException();
//        }
...
//        }
//    }
//    static void helper(Map<Integer, Integer> map, int x, int y) {
//        int min = Math.min(x, y), max = Math.max(x, y);
//        if (min == max) {
//            return;
//        }
//        if (map.containsKey(min)) {
//            helper(map, map.compute());
//        }
//    }
