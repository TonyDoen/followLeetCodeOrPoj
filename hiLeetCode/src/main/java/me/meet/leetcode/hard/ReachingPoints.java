...
public final class ReachingPoints {
    ...
    //
    static boolean reachingPoints3(int sx, int sy, int tx, int ty) {
    ...
    static boolean reachingPoints4(int sx, int sy, int tx, int ty) {
        while (tx >= sx && ty >= sy) {
            if (tx > ty) tx %= ty;
            else ty %= tx;
        }
    ...
    public static void main(String[] args) {
        ...
        boolean res3 = reachingPoints3(sx, sy, tx, ty);
        boolean res4 = reachingPoints4(sx, sy, tx, ty);
