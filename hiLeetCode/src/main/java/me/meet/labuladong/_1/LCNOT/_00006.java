...
public final class _00006 {
     ...
     *
     * 现在，你只可以按键N次(使用上述4种按键); 请问屏幕上最多可以显示几次 'A' 呢
     *
     * 例子1：
     * input:   N = 3
     * output:  3
     * explain: 我们最多可以在屏幕上显示3个 'A' 通过如下顺序按键; A, A, A
     *
     * 例子1：
     * input:   N = 7
     * output:  9
     * explain: 我们最多可以在屏幕上显示9个 'A' 通过如下顺序按键; A, A, A, Ctrl-A, Ctrl-C, Ctrl-V, Ctrl-V
     *
     ...
     *     ...  3   4   5   6   7   8   9
     * dp       3
     * 操作序列  C-A  C-C  C-V  C-V  C-V  C-V
     * i-j 次 C-V; 加上 dp[j-2] 本身
     *
     ...
     *     dp(n - 2, a_num, a_num)        # C-A C-C
     *
     * 看这个穷举逻辑，是有可能出现这样的操作序列C-A C-C，C-A C-C...或者C-V,C-V,...。
